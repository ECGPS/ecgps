...
const speakers = [
  ...
  },
  {
    ...
    talkTitle: "Accelerated continuous theta-burst stimulation (a-cTBS) targeting the left primary motor cortex (M1) improves social communication impairment in autistic children"
  },
  {
    name: `Tingyong Feng`,
